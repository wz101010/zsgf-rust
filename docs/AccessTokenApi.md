...
------------- | ------------- | ------------- | ------------- | -------------
**app_key** | **String** |  | [required] |
**access_token_post_request** | Option<[**AccessTokenPostRequest**](AccessTokenPostRequest.md)> | 令牌创建请求参数 |  |
...
**id** | **i64** | 令牌ID | [required] |
**app_key** | **String** |  | [required] |
**access_token_put_request** | Option<[**AccessTokenPutRequest**](AccessTokenPutRequest.md)> | 令牌更新请求参数 |  |
