...
------------- | ------------- | ------------- | ------------- | -------------
**app_key** | **String** |  | [required] |
**source_name** | Option<**String**> | 原文件或文件夹名称 |  |
**dest_name** | Option<**String**> | 新文件或文件夹名称 |  |
...
> models::BooleanApiResponse file_upload(app_key, path, file)
上传文件
