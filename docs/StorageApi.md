...
> models::BooleanApiResponse storage_batch_update(table, filter, app_key, request_body, replace)
批量更新指定条件的数据
...
------------- | ------------- | ------------- | ------------- | -------------
**table** | **String** | 表名称 | [required] |
**filter** | **String** | 查询条件 | [required] |
**app_key** | **String** |  | [required] |
**request_body** | [**Vec<serde_json::Value>**](serde_json::Value.md) | 更新的字段 | [required] |
**replace** | Option<**bool**> | 是否为全量替换，默认为 false |  |[default to false]
