...
pub struct ServiceSettingSettingPostResultApiResponse {
    ...
    pub data: Option<Box<models::ServiceSettingSettingPostResult>>,
    /// 错误信息
    #[serde(rename = "error", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub error: Option<Option<String>>,
}

impl ServiceSettingSettingPostResultApiResponse {
    pub fn new() -> ServiceSettingSettingPostResultApiResponse {
